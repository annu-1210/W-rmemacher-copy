              ...
              return (
                <article className="flex flex-col gap-y-4 lg:gap-y-6 w-full" key={item.id}>
                  ...
                  <div className="flex flex-col gap-y-1 xl:gap-y-2 max-w-[578px] w-full ">
                    <h4 className="font-MontserratMedium leading-[24px] lg:leading-[30px] text-base lg:text-xl text-secondary">
                      {item.title}
                    </h4>
                    <p className="text-xs lg:text-sm xl:text-base font-MontserratRegular leading-[18px] lg:leading-5 xl:leading-6 ">
                      {item.description}
