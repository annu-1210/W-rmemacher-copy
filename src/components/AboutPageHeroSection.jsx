...
function AboutPageHeroSection() {
  ...
  return (
    <section className="hero-section">
      <div className="max-w-[1920px] h-[378px] md:h-[460px] lg:h-[662px] xl:h-[760px] relative overflow-hidden top-0 rounded-2xl bg-aboutHero-bg bg-cover bg-center before:absolute before:inset-0 before:bg-custom-gradient2 before:z-0 transition-all duration-100 ease-in-out">
        <div className="container px-5 lg:px-10 w-full absolute top-[150px] md:top-[200px] lg:top-[340px] xl:top-[363px] flex max-w-[1920px]">
