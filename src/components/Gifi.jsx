...
function Gifi() {
  ...
  return (
    <div className="max-w-[1920px] relative overflow-hidden rounded-2xl mt-[130px] lg:mt-[150px] h-[480px] lg:h-[554px] xl:h-[650px] mx-auto">
      <Image
        src="/images/gif-poster.jpeg"
        alt="gif Image"
        width={1400}
        height={650}
        className="w-full max-w-[1920px] h-[480px] lg:h-full rounded-2xl absolute top-px z-0 "
      />
      <div className="w-full bg-background py-10 flex justify-center h-full z-0 brightness-50">
        <div className="flex flex-col max-w-[590px] mx-auto justify-between z-20">
          <div className="flex flex-col gap-y-1 lg:gap-5 xl:gap-[26px] items-center relative z-99">
            <a href="/" className="flex w-[147px] h-[127px] justify-center">
              <Image
                src="/images/w-2.png"
                alt="Image"
                width={147}
                height={127}
                className="w-full max-w-[100px] lg:max-w-[120px] xl:max-w-[147px] h-[90px] lg:h-[116px] xl:max-h-[127px] relative z-99"
              />
            </a>
