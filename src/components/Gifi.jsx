...
function Gifi() {
  ...
  return (
    <div className="max-w-[1920px] relative overflow-hidden rounded-2xl mt-20 xsm:mt-[100px] md:mt-[130px] lg:mt-[150px] h-[210px] xsm:h-[300px] sm:h-[380px] md:h-[480px] lg:h-[554px] xl:h-[650px] mx-auto bg-custom-gradient2 ">
      <Image
        src="/images/gif-poster.jpeg"
        alt="gif Image"
        width={1400}
        height={650}
        className="w-full max-w-[1920px] h-[210px] xsm:h-[300px] sm:h-[380px] md:h-[480px] lg:h-full rounded-2xl absolute top-0 z-0 "
      />
      <div className="w-full py-4 xsm:py-6 md:py-10 flex justify-center h-full z-0 ">
        <div className="flex flex-col max-w-[590px] mx-auto justify-between z-20">
          <div className="flex flex-col gap-y-2 xsm:gap-y-4 lg:gap-5 xl:gap-[26px] items-center relative z-99">
            ...
            <p className="max-w-[230px] xsm:max-w-[350px] sm:max-w-[400px] md:max-w-[590px] text-center relative z-99">
