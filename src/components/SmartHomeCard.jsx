...
function SmartHomeCard() {
  ...
  return (
    <div className="max-w-[1400px] flex justify-between items-center mx-auto gap-4 lg:gap-7 bg-transparent flex-row">
      <div className="w-[356px] lg:w-[686px] h-[450px] lg:h-[574px] flex items-center justify-center bg-custom-gradient6 rounded-2xl">
      ...
      <div className="max-w-[356px] lg:max-w-[686px] h-[450px] lg:h-[574px] flex items-center justify-center bg-primary rounded-2xl p-5 lg:px-[38px]">
        <div className="max-w-[601px] flex flex-col gap-2 justify-start items-start">
          <h3 className="text-xl xsm:text-2xl sm:text-3xl md:text-4xl lg:text-[38px] xl:text-[42px] leading-5 xsm:leading-[51.2px] text-start max-w-[510px]">
            <span className="font-MontserratMedium">Smart Home mit</span> <br />
            <span className="font-PpEditorialRegular italic leading-5 xsm:leding-10 lg:leading-[53.7px]">
              der Wise App
            </span>
          </h3>
