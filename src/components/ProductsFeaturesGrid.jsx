...
const AnimatedFeature = ({ title, description, gifSrc, alt }) => {
  return (
    <article className="relative max-w-[558px] max-h-[548px] rounded-2xl shadow-lg overflow-hidden">
      <div className=" w-[558px] h-[548px] relative">
        <Image
          src={gifSrc}
          alt={alt}
          width={558}
      ...
      <div className="absolute top-[357px] left-7 max-w-[490px] flex flex-col gap-3 text-primary">
...
const ProductsFeaturesGrid = () => {
  ...
  return (
    <section className="container max-w-[1140px] 4xl:max-w-[1440px mt-[150px] mx-auto flex gap-6">
      <AnimatedFeature
        title="LED Display"
