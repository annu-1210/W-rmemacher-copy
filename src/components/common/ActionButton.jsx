...
const button = tv(
  {
    ...
    variants: {
      color: {
        ...
        secondary: "gradient-border transition-colors duration-500 hover:bg-custom-gradient hover:!text-primary",
        tertiary:
          "bg-transparent gradient-border3 !text-ironGray hover:bg-custom-gradient hover:!text-primary",
        quaternary: "custom-gradient-border hover:text-ironGray",
      },
      size: {
        ...
        xxl: "w-[296px] !h-10 xsm:!h-12 !h-14 px-4 xsm:px-5 md:px-6 py-2.5 xsm:py-3 md:py-3.5 !text-base xsm:!text-lg sm:!text-xl xl:!text-2xl",
        xxxl: "w-full px-4 xsm:px-5 md:px-6 py-2.5 xsm:py-3 md:py-3.5 !text-base xsm:!text-lg sm:!text-xl xl:!text-2xl !h-10 xsm:!h-12 sm:!h-14",
      },
    },
  },
  {
