...
const text = tv(
  {
    ...
    variants: {
      ...
      size: {
        xsm: "text-[8px] xsm:text-[10px] sm:text-xs lg:text-sm xl:text-base font-MontserratRegular leading-3 sm:leading-4 lg:leading-5 xl:leading-6 ",
        ...
        md: "font-MontserratRegular text-xs xsm:text-sm sm:text-base lg:text-xl xl:text-2xl leading-4 xsm:leading-5 sm:leading-6 lg:leading-8 xl:leading-9 ",
