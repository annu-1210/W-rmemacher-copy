...
function InfoBlock({ width, height, imageSrc, description, rowDirection }) {
  return (
    ...
    >
      <div className="max-w-[680px] xl:max-w-[686px] bg-primary rounded-2xl px-10 py-10 ">
      ...
      <div
        className="w-[610px] lg:w-[680px] xl:w-[608px] 2xl:w-[686px] rounded-2xl h-[450px] lg:h-full"
