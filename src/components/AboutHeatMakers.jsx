...
function AboutHeatMakers() {
  ...
  return (
    <div className="max-w-[900px] xl:max-w-[1140px] flex justify-between  mx-auto mt-28 xl:mt-[150px]">
      <h3 className=" text-4xl  xl:text-[42px] font-MontserratMedium leading-[45px] xl:leading-[51.2px] text-center">
        Über <span className="!font-PpEditorialRegular italic ">Wärmemacher</span>
      </h3>
      <div className="flex flex-col gap-y-4 max-w-[530px] xl:max-w-[655px]">
