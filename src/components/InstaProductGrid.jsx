...
function InstaProductGrid() {
  ...
  return (
    <div className="max-w-[1140px] mx-auto flex flex-col gap-y-[60px] justiy-center">
      ...
      <div className="flex items-center justify-between gap-7 w-full">
        <div className="flex flex-wrap gap-7 max-w-[569px]">
          {gramGallery.map((item) => {
            return (
              <div
                className="max-h-[283px] rounded-2xl "
