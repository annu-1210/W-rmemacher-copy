          ...
          <form className="flex flex-col gap-y-6 w-full text-ironGray text-[10px] sm:text-xs lg:text-sm xl:text-base font-MontserratRegular leading-3 sm:leading-4 lg:leading-5 xl:leading-6 ">
            <div className="flex items-center gap-3.5 w-full">
              <div className="relative w-full ">
                <label
                  htmlFor="name"
                  className="absolute top-[-12px] left-4 px-1 bg-primary"
                >
                  Vollständiger Name
                </label>
                <input
                  type="text"
                  id="name"
                  className="block w-full p-2 border border-mutedCharcoal rounded-lg text-base outline-none h-[52px]"
                  required
                />
              </div>
            ...
            <div className="relative ">
              ...
              <textarea
                id="message"
                className="block min-h-[204px] w-full p-2 border border-mutedCharcoal rounded-lg outline-none resize-y"
                required
              ></textarea>
            </div>
