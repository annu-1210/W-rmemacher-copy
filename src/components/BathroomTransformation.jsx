...
function BathroomTransformation() {
  ...
  return (
    <div className="max-w-[728px] lg:max-w-[860px] xl:max-w-[1140px] mx-auto flex flex-col gap-12 lg:gap-[60px] mt-28 lg:mt-[150px]">
      <div className="max-w-[831px] flex flex-col gap-y-2 lg:gap-y-3">
      ...
      <div className="flex flex-row-reverse gap-5 lg:gap-6 w-full">
